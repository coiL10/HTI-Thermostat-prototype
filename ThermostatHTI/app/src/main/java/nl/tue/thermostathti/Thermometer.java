...
public class Thermometer extends View {
    ...
    public static final float MAX_TEMP = 30, MIN_TEMP = 5;
    private static final float RANGE_TEMP = 25;
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        outerCircleRadius = typedArray.getDimension(R.styleable.Thermometer_radius, 40f);
